...
**주제**: 공공급식통합플랫폼(eaT) — 필자가 복직 예정인 한국농수산식품유통공사(aT)가 운영하는 시스템 — 를 둘러싼 제도 이슈의
연혁을 여러 절로 나눠 조사하는 딥리서처. "보고서 작성법 자체"나 "위키백과 기반 새 주제"도 검토했으나, 전자는 자료끼리
서로 참조하는 링크 구조를 억지로 만들어야 했고 후자는 업무 연계가 없어 기각했다. 이 주제는 국정감사 지적 → 정책(시행령
개정) 대응 → 언론 후속보도 → 다음 국감 예고로 이어지는 **자연스러운 인용 사슬**이 이미 존재해 링크 구조 확보가 가장
쉬웠고, 복직 후 실제 업무(제도 개선 보고서 작성)에도 재활용 가능하다는 점에서 선택했다.
